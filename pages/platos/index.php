  ...
  <div class="page-header">
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 text-right">
					<div class="dropdown">
						<a class="btn btn-primary" id="addplato" href="javascript:void(0);"  role="button">
    ...
    <script type="text/javascript">
      $("#addplato").click(function(){
         funcionajax("pages/platos/addForm.php","container","");
      });
    </script>

  <div class="card-box pb-10">
    <div class="h5 pd-20 mb-0">Platos</div>
    <table class="data-table table nowrap" id="table14">
      ...
      <tbody>
        <?php
          ...
          $resultado_cnsc = $obj_cnsc->ConsultarPlatos();
             ...
             $cont = 0;
               ...
               ?>
                 <tr class="dato">
                   ...
                   <td><?php echo $listar_repuesto["categoria"]; ?></td>
...
<script type="text/javascript">
  ...
  $(".editar").click(function(){
    ...
    funcionajax("pages/platos/editarForm.php","container",a);
  });

<?php
  ...
  $resultado = $obj_mantenimiento->ConsultarIdUsuario($_POST['id']);
            			...
            			<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" id="primer_nombre" value="<?php echo $listar['nombre']; ?>" name="primer_nombre" class="form-control">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Segundo Nombre :</label>
												<input type="text" id="segundo_nombre" value="<?php echo $listar['apellido']; ?>"  name="segundo_nombre" class="form-control">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" id="direccion"  value="<?php echo $listar['direccion']; ?>"  name="direccion" class="form-control">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Telefono :</label>
												<input type="text" id="telefono" value="<?php echo $listar['telefono']; ?>"  name="telefono" class="form-control">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" id="fechaNac" value="<?php echo $listar['fechaNac']; ?>"   name="fechaNac" class="form-control date-picker" readonly placeholder="00/00/00">
											</div>
										</div>
									</div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="email" id="email" value="<?php echo $listar['correo']; ?>"  name="email" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">

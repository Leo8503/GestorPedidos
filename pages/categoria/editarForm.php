<?php
  ...
  $resultado = $obj_mantenimiento->ConsultarIdCategoria($_POST['id']);
  ...
  <div class="page-header">
      <div class="row">
        <div class="col-md-6 col-sm-12">
          <div class="title">
            <h4>Formulario Editar Categoria</h4>
          </div>
        </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <div class="product-img">
                        <img src="<?php if($listar["foto"] != "" && $listar["foto"] != "null"){ echo "pages/categoria/upload/".$listar["foto"];}else{ echo "images/default-50x50.gif";} ?>"    id="image" style="/* width: 100px; */height: 160px;" alt="Product Image">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea  id="categoria"  name="categoria" name="name" rows="3" cols="20" class="form-control"><?php echo $listar['nombre']; ?> </textarea>
                       </div>
                    </div>
                  </div>

<div class="xs-pd-20-10 pd-ltr-20">
  <div class="title pb-20">
    <h2 class="h3 mb-0">Domiciliario</h2>
  </div>
  ...
  <div class="page-header">
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 text-right">
					<div class="dropdown">
						<a class="btn btn-primary" id="adddomiciliario" href="javascript:void(0);"  role="button">
    ...
    <script type="text/javascript">
      $("#adddomiciliario").click(function(){
         funcionajax("pages/domiciliario/addForm.php","container","");
      });
    </script>

  <div class="card-box pb-10">
    <div class="h5 pd-20 mb-0">Domiciliario</div>
    <table class="data-table table nowrap" id="table14">
      ...
      <tbody>
        <?php
         ...
         $resultado_cnsc = $obj_cnsc->ConsultarDomiciliario();
            ...
            $cont = 0;
              ...
              ?>
                <tr class="dato">
                  ...
                  <td><?php echo $listar_repuesto["tipo"]; ?></td>
...
<script type="text/javascript">
  ...
  $(".editar").click(function(){
    ...
    funcionajax("pages/domiciliario/editarForm.php","container",a);
  });
  ...
  $(".eliminar").click(function(){
    ...
    $.ajax({
       url : 'pages/domiciliario/eliminar.php',
       data:  parametros,
       type: "post",

  ...
  <div class="page-header">
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 text-right">
					<!--<div class="dropdown">
						<a class="btn btn-primary" id="addcliente" href="javascript:void(0);"  role="button">
    ...
    <script type="text/javascript">
      $("#addcliente").click(function(){
         funcionajax("pages/clientes/addForm.php","container","");
      });
    </script>

  <div class="card-box pb-10">
    <div class="h5 pd-20 mb-0">Clientes</div>
    <table class="data-table table nowrap" id="table14">
      ...
      <tbody>
        <?php
         ...
         $resultado_cnsc = $obj_cnsc->ConsultarClientes();

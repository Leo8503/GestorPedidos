<?php
  ...
  $resultado = $obj_mantenimiento->ConsultarIdApoderado($_POST['id']);
  ...
  <div class="page-header">
      <div class="row">
        <div class="col-md-6 col-sm-12">
          <div class="title">
            <h4>Formulario Editar Representante</h4>
          </div>
        </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="identificacion" name="identificacion" readonly value="<?php echo $listar['identificacion']; ?>" type="text" class="form-control">
                      </div>
                    </div>
                  </div>
              		<div class="row">

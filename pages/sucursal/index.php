  ...
  <div class="page-header">
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 text-right">
					<div class="dropdown">
						<a class="btn btn-primary" id="addsucursal" href="javascript:void(0);"  role="button">
    ...
    <script type="text/javascript">
      $("#addsucursal").click(function(){
         funcionajax("pages/sucursal/addForm.php","container","");
      });
    </script>

  <div class="card-box pb-10">
    <div class="h5 pd-20 mb-0">Sucursal</div>
    <table class="data-table table nowrap" id="table14">
      ...
      <tbody>
        <?php
          ...
          $resultado_cnsc = $obj_cnsc->ConsultarSucursal();
             ...
             $cont = 0;
               ...
               ?>
                 <tr class="dato">
                   <td><?php echo $cont; ?></td>
                   <td>
                     <img src="<?php if($listar_repuesto["foto"] != "" && $listar_repuesto["foto"] != "null"){ echo "pages/sucursal/upload/".$listar_repuesto["foto"];}else{ echo "vendors/images/photo1.png";} ?>"  class="shadow" width="40" alt="">
                   </td>
                   <td><?php echo $listar_repuesto["telefono"]; ?></td>
                   <td><?php echo $listar_repuesto["direccion"]; ?></td>
                   <td><?php echo $listar_repuesto["latitud"].' '.$listar_repuesto["longitud"]; ?></td>
...
<script type="text/javascript">
  ...
  $(".editar").click(function(){
    ...
    funcionajax("pages/sucursal/editarForm.php","container",a);
  });
  ...
  $(".eliminar").click(function(){
    ...
    $.ajax({
       url : 'pages/sucursal/eliminar.php',
       data:  parametros,
       type: "post",
